namespace LawrApp
{
	partial class frm_Director
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel_Right_Body.TabIndex = 4;
			// 
			// panel_Left_Body
			// 
			...
			this.cboYearPeriod.TabIndex = 10;
			...
			this.lblAddressInstitucion.Location = new System.Drawing.Point(3, 32);
			this.lblAddressInstitucion.Name = "lblAddressInstitucion";
			this.lblAddressInstitucion.Size = new System.Drawing.Size(385, 18);
			this.lblAddressInstitucion.TabIndex = 9;
			this.lblAddressInstitucion.Text = "Av. Jose Granda 432 - Chulucanas, Piura";
			...
			this.lblNameInstitucion.Location = new System.Drawing.Point(3, 3);
			this.lblNameInstitucion.Name = "lblNameInstitucion";
			this.lblNameInstitucion.Size = new System.Drawing.Size(385, 31);
			this.lblNameInstitucion.TabIndex = 8;
			this.lblNameInstitucion.Text = "I.E.P Johannes Gutemberg";
			...
			this.ptbLogoInstitucion.TabIndex = 7;
			...
			this.metroLabel1.Text = "Menu Principal - Director(a)";
			...
			this.flpanel_Mensajes.Location = new System.Drawing.Point(3, 37);
			this.flpanel_Mensajes.Name = "flpanel_Mensajes";
			this.flpanel_Mensajes.Size = new System.Drawing.Size(247, 391);
			this.flpanel_Mensajes.TabIndex = 14;
			// 
			// metroLabel5
			// 
